...
import com.jude.easyrecyclerview.swipe.EasyRemoveDataObserver;
...
public class EasyRemoveRecyclerView extends FrameLayout {

    public static final String TAG = "EasyRemoveRecyclerView";
    ...
    public EasyRemoveRecyclerView(Context context) {
        super(context);
        initView();
    }

    public EasyRemoveRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public EasyRemoveRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_progress_remove_recyclerview, this);
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        adapter.registerAdapterDataObserver(new EasyRemoveDataObserver(this));
        showRecycler();
    }
